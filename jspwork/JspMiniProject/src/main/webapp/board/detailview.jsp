...
<body>
	...
	<div style="margin: 30px 30px;">
		...
		<table class="table table-bordered" style="width: 600px;">
			...
			<tr>
				<td><b>작성자: <%=dto.getWriter()%></b><br> <span class="day"><%=sdf.format(dto.getWriteday())%>
						&nbsp;&nbsp;조회
						<%=dto.getReadcount()%>
					</span></td>
			</tr>
			...
			<!-- 댓글 -->
			<tr>
				<td><b class="acount">댓글 <span style="color: red; font-weight: bold;">0</span></b>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal" id="btnupdate">댓글수정</button>
				</div>
			</div>
