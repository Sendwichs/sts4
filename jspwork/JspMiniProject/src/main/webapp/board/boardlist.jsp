...
List<SmartDto> list = dao.getAllBoard(start, perPage);
	...
	<div style="margin: 30px 30px; width: 800px;">
		...
		<table class="table table-bordered">
			...
			<tr>
				...
				<td><a href="index.jsp?main=board/detailview.jsp?num=<%=dto.getNum()%>&currentPage=<%=currentPage%>"><%=dto.getSubject()%></a> <%
 if (dto.getAnswercount() > 0) {
 %> <a href="index.jsp?main=board/detailview.jsp?num=<%=dto.getNum()%>&currentPage=<%=currentPage%>" style="color: red;">[<%=dto.getAnswercount()%> ]
				</a> <%
 }
 %></td>
