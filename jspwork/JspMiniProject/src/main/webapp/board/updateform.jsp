...
<body>
	<form action="board/updateaction.jsp" method="post">
		...
		<table class="table table-bordered" style="width: 800px; margin-left: 100px;">
			...
			<tr>
				<td colspan="2">
					<textarea name="content" id="content" required="required" style="width: 100%; height: 300px; display: none;" <%=dto.getSubject()%>></textarea>

				</td>
			</tr>
			<tr>
				<td colspan="2" align="center">
					<button type="button" class="btn btn-warning" style="width: 120px;" onclick="submitContents(this)">DB수정</button>
					<button type="button" class="btn btn-warning" style="width: 120px;" onclick="location.href='index.jsp?main=board/boardlist.jsp'">목록</button>
				</td>
			</tr>
