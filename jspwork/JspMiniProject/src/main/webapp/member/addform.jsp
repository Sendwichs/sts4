		...
		<table class="table table-bordered" style="width: 500px;">
			...
			<tr>
				...
				<td><input type="password" name="pass" id="pass"
					class="form-control" required="required" style="width: :100px;"
					placeholder="비밀번호"><input type="password" name="pass2"
					id="pass2" class="form-control" required="required"
					style="width: :100px;" placeholder="비밀번호 확인"></td>
			</tr>
			...
			<tr>
				...
				<td><input type="text" name="email1" class="form-control"
					required="required" style="width: 120px;"> <b>@</b> <input
					type="text" name="email2" class="form-control" required="required"
					style="width: 120px;" id="email2"> <select id="selEmail"
					class="form-control">
