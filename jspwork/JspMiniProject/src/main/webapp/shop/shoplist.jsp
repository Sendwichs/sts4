		...
		$("a.godetail")
				.click(
						function() {
							...
							location.href = "index.jsp?main=shop/detailpage.jsp?shopnum="
									+ shopnum;
						})
	})
</script>
			...
			<div id="tabs-1" class="tab-pane fade in active">
				...
				<table class="table table-bordered" style="width: 1000px;">
					...
					<tr>
						...
						%>
						<td>
							<a shopnum="<%=dto.getShopnum()%>" style="cursor: pointer;" class="godetail"><img src="shopsave/<%=photo%>" class="photo"> <br> <%=dto.getSangpum()%> <b style="color: red; font-size: 0.8em;"><%=sale%>%
